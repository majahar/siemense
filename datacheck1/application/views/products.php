                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
							...
							?>
							<button type="button" class="btn btn-default" onclick="pageRedirect('<?php echo SITE_PATH?>Products')" >Clear Filter</button>
							<a class="btn btn-default" href="<?php echo SITE_PATH?>addProducts" >Add News</a>
