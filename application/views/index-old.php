								...
								<div class="row">
									<div class="col-md-6">
										<div class="content">
											...
											<a href="<?php echo SITE_URL_IMAGES;?>/product/2-industry-software/2-NX-CAD-PLM.pdf" target="_blank"><h6>Mechatronics Concept Designer</h6></a>
										</div>
									</div>
									<div class="col-md-6">
										<div class="content">
											...
											<div  class="slider owl-carousel">
												<div class="item">
													<div class="content">
														<div class="video_container">
															<video controls id="my-video">
																<source src="<?php echo SITE_URL_IMAGES;?>product/3-digital-enterprise/DES-FOMS.mp4" type="video/mp4">
															</video>
														</div>
													</div>
												</div>
												<div class="item">
													<div class="content">
														<div class="video_container">
															<video controls id="my-video">
																<source src="<?php echo SITE_URL_IMAGES;?>product/3-digital-enterprise/DES-FOMS1.mp4" type="video/mp4">
															</video>
														</div>
													</div>
												</div>
												<div class="item">
													<div class="content">
														<div class="video_container">
															<video controls id="my-video">
																<source src="<?php echo SITE_URL_IMAGES;?>product/3-digital-enterprise/DES-FOMS2.mp4" type="video/mp4">
															</video>
														</div>
													</div>
												</div>
												<div class="item">
													<div class="content">
														<div class="video_container">
															<video controls id="my-video">
																<source src="<?php echo SITE_URL_IMAGES;?>product/3-digital-enterprise/DES-FOMS3.mp4" type="video/mp4">
															</video>
														</div>
													</div>
												</div>
												<div class="item">
													<div class="content">
														<div class="video_container">
															<video controls id="my-video">
																<source src="<?php echo SITE_URL_IMAGES;?>product/3-digital-enterprise/DES-FOMS4.mp4" type="video/mp4">
															</video>
														</div>
													</div>
												</div>
											...
											<div  class="slider owl-carousel">
												<div class="item">
													<div class="content">
														<div class="video_container">
															<video controls id="my-video">
																<source src="<?php echo SITE_URL_IMAGES;?>product/4-mindsphere/imdata.mp4" type="video/mp4">
															</video>
														</div>
													</div>
												</div>
												<div class="item">
													<div class="content">
														<div class="video_container">
															<video controls id="my-video">
																<source src="<?php echo SITE_URL_IMAGES;?>product/4-mindsphere/MindSphere.mov" type="video/mov">
															</video>
														</div>
													</div>
												</div>
												<div class="item">
													<div class="content">
														<div class="video_container">
															<video controls id="my-video">
																<source src="<?php echo SITE_URL_IMAGES;?>product/4-mindsphere/MindSphere_Video_MindSphere Trailer_EN.mp4" type="video/mp4">
															</video>
														</div>
													</div>
												</div>
											...
											<div  class="slider owl-carousel">
												<div class="item">
													<div class="content">
														<div class="video_container">
															<video controls id="my-video">
																<source src="<?php echo SITE_URL_IMAGES;?>product/8-drives/sinamics-v20-2016-en.mp4" type="video/mp4">
															</video>
														</div>
													</div>
												</div>
												<div class="item">
													<div class="content">
														<div class="video_container">
															<video controls id="my-video">
																<source src="<?php echo SITE_URL_IMAGES;?>product/8-drives/v90-promotion-video-en-08_1.mp4" type="video/mp4">
															</video>
														</div>
													</div>
												</div>
											...
											<div  class="slider owl-carousel">
												<div class="item">
													<div class="content">
														<div class="video_container">
															<video controls id="my-video">
																<source src="<?php echo SITE_URL_IMAGES;?>product/9-solution-for-machine-tools/Digitalization-for-Machine-Tools.mp4" type="video/mp4">
															</video>
														</div>
													</div>
												</div>
												<div class="item">
													<div class="content">
														<div class="video_container">
															<video controls id="my-video">
																<source src="<?php echo SITE_URL_IMAGES;?>product/9-solution-for-machine-tools/SINUMERIK-PPU290.mp4" type="video/mp4">
															</video>
														</div>
													</div>
												</div>
												<div class="item">
													<div class="content">
														<div class="video_container">
															<video controls id="my-video">
																<source src="<?php echo SITE_URL_IMAGES;?>product/9-solution-for-machine-tools/SINUMERIK-TOP-SURFACE.mp4" type="video/mp4">
															</video>
														</div>
													</div>
												</div>
											...
											<div  class="slider owl-carousel">
												<div class="item">
													<div class="content">
														<div class="video_container">
															<video controls id="my-video">
																<source src="<?php echo SITE_URL_IMAGES;?>product/11-energy-efficient-motors/Low-voltage-motors-in-IE4.mp4" type="video/mp4">
															</video>
														</div>
													</div>
												</div>
										...
										<div class="slider-container">
											<div  class="slider owl-carousel">
												<div class="item">
													<div class="content">
														<div class="video_container">
															<iframe src="https://www.youtube.com/embed/kPDnw3_1GOI" frameborder="0" allowfullscreen></iframe>
														</div>
													</div>
												</div>
												<div class="item">
			...
			<div class="container">
				...
				<div class="col-md-2">
					<div class="follow_us">
						<h3>Follow us</h3>
						<ul>
							<li><a href="#"><i class="fa fa-twitter fa-twitt fa-lg" aria-hidden="true"></i></a></li>
