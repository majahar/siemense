                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
							...
							?>
							<button type="button" class="btn btn-default" onclick="pageRedirect('<?php echo SITE_PATH?>news')" >Clear Filter</button>
							<a class="btn btn-default" href="<?php echo SITE_PATH?>addNews" >Add News</a>
