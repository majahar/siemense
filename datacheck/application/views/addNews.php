						...
						<div class="col-lg-5">
							<form role="form" name="frmData" id="frmData" method="post" enctype="multipart/form-data" >
								<div class="form-group">
									<label>Heading</label>
									<input class="form-control" name="name" id="name" value="<?php echo $form_data['heading'];?>">
								...
								<div class="form-group">
									<label>Link</label>
									<input class="form-control" name="newlink" id="newlink" value="<?php echo $form_data['newlink'];?>">
									<p class="help-block validation_message_error"  ></p>
								</div>
								<div class="form-group">
									<label>Date</label>
									<input type="date" name="newsdate" id="newsdate" data-date-inline-picker="true" />
									<p class="help-block validation_message_error"  ></p>
								</div>
								<div class="form-group">
									<label>Image</label>
